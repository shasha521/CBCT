...
class Options():
    ...
    def init(self, parser):        
        ...
        # args for saving 
        parser.add_argument('--save_dir', type=str, default ='./logs/2/',  help='save dir')
        ...
        parser.add_argument('--train_dir', type=str, default ='./datasets/denoising/train',  help='dir of train data')
        parser.add_argument('--val_dir', type=str, default ='./datasets/denoising/val',  help='dir of train data')
